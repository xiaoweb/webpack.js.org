...
<div align="center">
  ...
  <p>
    Plugin and Loader for <a href="http://webpack.js.org/">webpack</a> to
    optimize (compress) all images using{' '}
    <a href="https://github.com/imagemin/imagemin">imagemin</a>. Do not worry
    about size of images, now they are always optimized/compressed.
  </p>
</div>
...
| **[`severityError`](https://github.com/webpack-contrib/image-minimizer-webpack-plugin/blob/master/severityError-1)** |           `{String}`            |               `'error'`               | Allows to choose how errors are displayed                                                         |
